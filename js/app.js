...
var supplements = [
    ...
    {icon:'🧲',title:'Magnesio',desc:'1 pastilla antes de dormir',tip:'Cofactor del ATP, mejora calidad del sueño profundo y reduce lactato.'},
    {icon:'⚡',title:'Zinc',desc:'1 pastilla antes de dormir',tip:'Apoyo inmunitario, recuperación muscular y mantenimiento hormonal.'},
...
var mealSupplements = {
    ...
    dinner: [],
    sleep: [{icon:'🧲',title:'Magnesio',desc:'1 pastilla'},{icon:'⚡',title:'Zinc',desc:'1 pastilla'},{icon:'😴',title:'Melatonina',desc:'Opcional'}]
};
